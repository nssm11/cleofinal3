import { Button, GhostLink, H1, InfoBox, Kicker, Para, Rule, Signature } from "../parts";
...
export function WelcomeEmail({ data, locale }: { data: WelcomeData; locale: EmailLocale }) {
  ...
  return (
    <EmailShell locale={locale} subject={t.subject} preheader={locale === "fr" ? "Sept univers, une exigence — et un conseil qui vous suit." : "Seb3a douniya, mezyan we7ed — wel nasiḥa temchi m3âk."}>
