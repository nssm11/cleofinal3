...
export function Initials({ name, size = 28, className }: { name: string; size?: number; className?: string }) {
  ...
  return (
    <span
      className={cn("inline-flex shrink-0 items-center justify-center bg-cinabre-soft font-display text-[11px] uppercase tracking-wide text-os-gold-2 ring-1 ring-cinabre-3/50", className)}
