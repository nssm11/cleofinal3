...
const MAISON: [string, string][] = [
  ...
  ["/ingredients", "Dictionnaire ingrédients"],
  ["/analyse-inci", "Analyse INCI"],
  ["/dupes", "Dupe finder"],
  ["/assistant-produit", "Assistant produit"],
  ["/boutiques", "Nos comptoirs"],
  ["/promotions", "Promotions"],
  ["/diagnostic", "Diagnostic peau"],
  ["/besoins", "Shop by concern"],
  ["/scanner", "Scanner produit"],
  ["/verifier-lot", "Vérifier un lot"],
  ["/courtes-dates", "Courtes dates"],
  ["/rappels", "Rappels sécurité"],
  ["/stock-live", "Stock live"],
  ["/stock-urgent", "Dernières unités"],
  ["/calendrier-reassort", "Calendrier réassort"],
  ["/guides-achat", "Guides d'achat"],
  ["/editorial", "Hub éditorial"],
...
const SERVICE: [string, string][] = [
  ...
  ["/reservation-boutique", "Réserver boutique"],
  ["/rendez-vous-retrait", "Rendez-vous retrait"],
  ["/panier-surveillance", "Surveillance panier"],
  ["/retours-rma", "Portail retours"],
  ["/echantillons", "Échantillons"],
  ["/liste-cadeaux", "Liste cadeau"],
  ["/communaute-avis", "Avis communauté"],
  ["/faq", "FAQ"],
  ["/newsletter", "Newsletter"],
  ["/consentements", "Consentements"],
  ["/donnees-personnelles", "Données personnelles"],
  ["/aide", "Aide & contact"],
  ["/conseil-pharmacien", "Conseil pharmacien"],
  ["/programme-club", "Cléopâtre Club"],
  ["/accessibilite", "Accessibilité"],
  ["/compte/comparaisons", "Comparaisons"],
  ["/compte/marques", "Marques suivies"],
  ["/compte/etagere", "Mon étagère"],
