...
const GLYPHS: Record<string, typeof HomeIcon> = {
  ...
  "/compte/comparaisons": CompareIcon,
  "/compte/marques": StoreIcon,
  "/compte/vus-recemment": ClockIcon,
  "/compte/etagere": PackageIcon,
...
export function AccountNav() {
  ...
  const items = [
    ...
    { href: "/compte/comparaisons", l: "Comparaisons", d: "Tableaux sauvegardés", n: "11" },
    { href: "/compte/marques", l: "Marques", d: "Laboratoires suivis", n: "12" },
    { href: "/compte/vus-recemment", l: "Vus récemment", d: "Historique local", n: "13" },
    { href: "/compte/etagere", l: "Étagère", d: "Produits ouverts", n: "14" },
