...
export function VisageAdvice({ copy }: { copy: Copy }) {
  return (
    <section aria-label={copy.univers.askAdvice} className="bg-night">
      <div className="container-wide pb-20 lg:pb-28">
        <div className="grid gap-10 border border-film-line bg-night-2/50 px-6 py-12 sm:px-10 lg:grid-cols-12 lg:items-center lg:gap-8 lg:px-14 lg:py-16">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 text-[14px] leading-[1.85] text-haze">{copy.categorie.doubtCta}</p>
          </div>
          <div className="flex flex-col items-start gap-6 lg:col-span-5 lg:items-end">
            ...
            <Link
              href="/boutiques"
              className="group inline-flex min-h-11 items-center gap-2.5 text-[11px] font-bold uppercase tracking-[0.22em] text-haze transition-colors duration-500 hover:text-cinabre-3"
            >
