  ...
  return (
    <div className="shell py-10 lg:py-14">
      <div className="flex items-center gap-6">
        <span className="h-px w-10 animate-pulse bg-iodine-deep/60" />
        <span className="font-ant uppercase text-[13px] font-light tracking-[0.34em] text-faint">CLÉOPÂTRE</span>
      </div>
